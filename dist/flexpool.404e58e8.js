window.onload = function() {
    ...
    chrome.storage.sync.get([
        ...
        if (!chrome.runtime.error && items.storedID != undefined) {
            var storedID, storedServer = items.flexStoredID;
            items.flexStoredServer;
            console.log(items.flexStoredID, items.flexStoredServer);
        }
    });
...
//# sourceMappingURL=flexpool.404e58e8.js.map
