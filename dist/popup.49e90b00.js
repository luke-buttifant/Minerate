...
window.onload = function() {
    ...
    requestBtn.onclick = async ()=>{
        ...
        while(serversLength--)fetch(i + baseUrl + id).then((response)=>{
            if (response.ok) {
            ...
            } else if (response.status === 404 && serversLength == 0) return Promise.reject('Attemping Server: ' + i);
...
//# sourceMappingURL=popup.49e90b00.js.map
