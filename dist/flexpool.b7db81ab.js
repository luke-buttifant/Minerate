window.onload = function() {
    ...
    chrome.storage.sync.get('flexStoredID', function(result) {
        console.log(result.flexStoredID);
        if (!chrome.runtime.error && result.storedID != undefined) {
...
//# sourceMappingURL=flexpool.b7db81ab.js.map
