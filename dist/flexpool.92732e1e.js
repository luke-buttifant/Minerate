window.onload = function() {
    ...
    chrome.storage.sync.get('flexStoredID', async function(result) {
        if (result.flexStoredID != undefined) {
            ...
            console.log(r_hashrate);
            if (r_hashrate > 100000000) {
                r_hashrate = (r_hashrate / 10000000).toFixed(2);
                frequency = 'TH/s';
            } else if (r_hashrate > 1000000 && r_hashrate < 100000000) {
...
//# sourceMappingURL=flexpool.92732e1e.js.map
