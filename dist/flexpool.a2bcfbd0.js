window.onload = function() {
    ...
    chrome.storage.sync.get('flexStoredID', async function(items) {
        if (!chrome.runtime.error && items.storedID != undefined) {
            var storedID = items.flexStoredID;
            storedServer = items.flexStoredServer;
...
//# sourceMappingURL=flexpool.a2bcfbd0.js.map
