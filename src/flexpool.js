...
window.onload = function(){
    ...
    const href = "https://www.flexpool.io/en-GB/miner/"
    var frequency;
    ...
    chrome.storage.sync.get('flexStoredID',  async function(result){
        if(result.flexStoredID != undefined){
            ...
            t_hashrateDiv.href = t_workersOnlineDiv.href = t_balanceDiv.href = href + ticker + "/" + storedID;
        ...
        requestBtn.addEventListener("click", async () => {
                try{
                    ...
                    chrome.storage.sync.set({'flexStoredID' : id}, function(){
